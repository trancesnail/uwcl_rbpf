...
///
/// ```
/// use uwcl_rbpf::syscalls::{BpfTimeGetNs, Result};
/// use uwcl_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use uwcl_rbpf::vm::{Config, SyscallObject};
/// use uwcl_rbpf::user_error::UserError;
///
...
///
/// ```
/// use uwcl_rbpf::syscalls::{BpfTracePrintf, Result};
/// use uwcl_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use uwcl_rbpf::vm::{Config, SyscallObject};
/// use uwcl_rbpf::user_error::UserError;
///
...
///
/// ```
/// use uwcl_rbpf::syscalls::{BpfGatherBytes, Result};
/// use uwcl_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use uwcl_rbpf::vm::{Config, SyscallObject};
/// use uwcl_rbpf::user_error::UserError;
///
...
///
/// ```
/// use uwcl_rbpf::syscalls::{BpfMemFrob, Result};
/// use uwcl_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use uwcl_rbpf::vm::{Config, SyscallObject};
/// use uwcl_rbpf::user_error::UserError;
///
...
///
/// ```
/// use uwcl_rbpf::syscalls::{BpfSqrtI, Result};
/// use uwcl_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use uwcl_rbpf::vm::{Config, SyscallObject};
/// use uwcl_rbpf::user_error::UserError;
///
...
///
/// ```
/// use uwcl_rbpf::syscalls::{BpfStrCmp, Result};
/// use uwcl_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use uwcl_rbpf::vm::{Config, SyscallObject};
///
...
/// extern crate time;
///
/// use uwcl_rbpf::syscalls::{BpfRand, Result};
/// use uwcl_rbpf::memory_region::{MemoryRegion, MemoryMapping};
/// use uwcl_rbpf::vm::{Config, SyscallObject};
/// use uwcl_rbpf::user_error::UserError;
///
