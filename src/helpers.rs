...
///
/// ```
/// use uwcl_rbpf::syscalls::bpf_time_getns;
/// use uwcl_rbpf::memory_region::MemoryRegion;
...
///
/// ```
/// use uwcl_rbpf::syscalls::bpf_trace_printf;
/// use uwcl_rbpf::memory_region::MemoryRegion;
/// use uwcl_rbpf::user_error::UserError;
///
/// let regions = [MemoryRegion::default()];
...
///
/// ```
/// use uwcl_rbpf::syscalls::gather_bytes;
/// use uwcl_rbpf::memory_region::MemoryRegion;
/// use uwcl_rbpf::user_error::UserError;
///
/// let regions = [MemoryRegion::default()];
...
///
/// ```
/// use uwcl_rbpf::syscalls::memfrob;
/// use uwcl_rbpf::memory_region::MemoryRegion;
/// use uwcl_rbpf::user_error::UserError;
///
