...
// Copyright 2020 Solana Maintainers <maintainers@put.com>
//
...
use uwcl_test_utils::{PROG_TCP_PORT_80, TCP_SACK_ASM, TCP_SACK_MATCH, TCP_SACK_NOMATCH};
        ...
        #[cfg(all(not(windows), target_arch = "x86_64"))]
        {
            ...
            match compilation_result {
                ...
                Ok(()) => {
                    ...
                    if !check_closure(&vm, result) || !uwcl_rbpf::vm::Tracer::compare(&_tracer_interpreter, tracer_jit) {
                        let analysis = uwcl_rbpf::static_analysis::Analysis::from_executable(&$executable);
...
fn execute_generated_program(prog: &[u8]) -> bool {
    ...
    if result_interpreter != result_jit
        || !uwcl_rbpf::vm::Tracer::compare(&tracer_interpreter, tracer_jit)
    {
        let analysis = uwcl_rbpf::static_analysis::Analysis::from_executable(&executable);
